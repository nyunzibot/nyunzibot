...
from fetch.pick_safebooru import pick_media_safebooru, FetchError, get_error_message, is_video_url
...
def setup(bot: discord.Client):
    ...
    async def cuddle(interaction: discord.Interaction, target: discord.User, extra_tags: Optional[str] = None):
        ...
        result = await pick_media_safebooru(tags, view.seen, tries=8, status_cb=on_status)
