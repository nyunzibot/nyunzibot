...
def setup(bot: discord.Client):
    ...
    async def succ(interaction: discord.Interaction, target: discord.User, base_tag: Optional[str] = None, extra_tags: Optional[str] = None):
        ...
        base = base_tag or SUCC_BASE
        tags = build_tag_ladder(base, SUCC_POSITIVE_SETS)
